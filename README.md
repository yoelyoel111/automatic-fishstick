...
### שימוש פרטי
הפרויקט זמין לשימוש פרטי חופשי ללא תשלום.

### שימוש מסחרי והעתקה
שימוש מסחרי, העתקה, שכפול או הפצה של הקוד או החומר דורשים רשות מפורשת מראש.

לבקשת רשות לשימוש מסחרי, צרו קשר: yoelyoel8a@gmail.com

### הגבלות
- אין להשתמש בקוד או בחומר למטרות מסחריות ללא רשות
- אין להעתיק, לשכפל או להפיץ את הקוד ללא רשות
- אין להציג את הפרויקט כפיתוח עצמי
- יש לשמור על זכויות היוצרים והקרדיטים המקוריים
